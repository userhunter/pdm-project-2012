...
public class MusicPlayerService extends Service {
	...
	//Oggetto di tipo IBinder che verrˆ restituito nel momento in cui il binding tra activity e servizio sarˆ completato
	private final IBinder m_binderCurrent = new LocalBinder();
	private final MP3Player m_mpMP3Player = new MP3Player();
	
	@Override
	//Funzione richiamata nel momento in cui il bind � avvenuto con successo e sarˆ responsabile della callback onServiceConnected() dell'activity
